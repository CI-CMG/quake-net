...
class QueryRangeDeterminerTest {
  ...
  void testHasObjects() {
    ...
    QueryRange expected = new QueryRange(LocalDate.parse("2016-01-01"), LocalDate.parse("2016-01-20"));
  ...
  void testLeapYear() {
    ...
    QueryRangeDeterminer queryRangeDeterminer = new QueryRangeDeterminer(initiatorProperties, () -> now, infoFileS3Actions);
    QueryRange queryRange = queryRangeDeterminer.getQueryRange().get();
    QueryRange expected = new QueryRange(LocalDate.parse("2023-02-01"), LocalDate.parse("2023-02-28"));
    assertEquals(expected, queryRange);
  }
  ...
  void testLeapYear2() {
    ...
    LocalDate now = LocalDate.parse("2025-02-28");
    QueryRangeDeterminer queryRangeDeterminer = new QueryRangeDeterminer(initiatorProperties, () -> now, infoFileS3Actions);
    QueryRange queryRange = queryRangeDeterminer.getQueryRange().get();
    QueryRange expected = new QueryRange(LocalDate.parse("2024-02-01"), LocalDate.parse("2024-02-29"));
    assertEquals(expected, queryRange);
  }
  ...
  void testCurrentDate2() {
    ...
    LocalDate now = LocalDate.parse("2014-05-10");
    QueryRangeDeterminer queryRangeDeterminer = new QueryRangeDeterminer(initiatorProperties, () -> now, infoFileS3Actions);
    assertTrue(queryRangeDeterminer.getQueryRange().isEmpty());
  }
  ...
  void testPartialMonth() {
    ...
    LocalDate now = LocalDate.parse("2014-05-20");
    QueryRangeDeterminer queryRangeDeterminer = new QueryRangeDeterminer(initiatorProperties, () -> now, infoFileS3Actions);
    QueryRange queryRange = queryRangeDeterminer.getQueryRange().get();
    QueryRange expected = new QueryRange(LocalDate.parse("2013-05-11"), LocalDate.parse("2013-05-20"));
    assertEquals(expected, queryRange);
  }
}