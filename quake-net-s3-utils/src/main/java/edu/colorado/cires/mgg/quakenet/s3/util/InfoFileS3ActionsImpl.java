...
public class InfoFileS3ActionsImpl implements InfoFileS3Actions {


  private final ObjectMapper objectMapper;
  private final S3FileUtilities fileUploader;

  public InfoFileS3ActionsImpl(S3ClientMultipartUpload s3, S3Client s3Client, ObjectMapper objectMapper) {
